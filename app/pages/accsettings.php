...
<div class="col-12">
    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#reset-ownerid" class="btn btn-warning"> <i class="fa fa-check"></i> Refresh OwnerID</button>
										...
										<div class="w-100">
											...
											<div class="fv-row mb-10">
                                                ...
                                                <label>Scan this QR code into your 2FA App.</label>
                                                        ...
                                                        <label>Alternatively, you can set it manually, code: <?php echo $code_2factor ?></label>
...
<!--begin::Modal - reset ownerid-->
<div class="modal fade" tabindex="-1" id="reset-ownerid">
   	<!--begin::Modal dialog-->
       <div class="modal-dialog modal-dialog-centered mw-900px">
				<!--begin::Modal content-->
				<div class="modal-content">
					<!--begin::Modal header-->
					<div class="modal-header">
                <h2 class="modal-title">Reset Owner ID</h2>
            ...
            <div class="modal-body">
                ...
                <p> Are you sure you want to reset ownerid for your account and all your applications? </p>
                </label>
            </div>									
            <div class="modal-footer">
                <form method="post">
                <button  class="btn btn-light" data-bs-dismiss="modal">No</button>
                <button  name="refreshownerid" class="btn btn-danger">Yes</button>
                </form>
            </div>
        </div>
    </div>
</div>
<!--end::Modal - reset ownerid-->
