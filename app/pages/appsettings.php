                            ...
                            <div class="card-body">
                                <form class="form" method="post">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <label class="form-control" style="height:auto;"><?php echo '<a href="https://'.($_SERVER['HTTP_HOST'] ?? $_SERVER['SERVER_NAME']).'/app/api/reseller/?app='.$_SESSION['secret'].'" target="target_" class="secretlink">https://'.($_SERVER['SERVER_NAME'] ?? $_SERVER['HTTP_HOST']).'/app/api/reseller/?app='.$_SESSION['secret'].'</a>';?></label>
                                         </div>
                                    </div>
                                        <br>
									<div class="form-group row">
