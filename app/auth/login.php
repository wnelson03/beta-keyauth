					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" method="post">
							...
							<div class="fv-row mb-10">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid" maxlength="6" placeholder="Two Factor Code (if applicable)" type="text" name="keyauthtwofactor" autocomplete="off" />
								<div class="form-group row">
                                </br>
								<!--end::Input-->
							</div>
...
if (isset($_POST['login']))
{
	...
	if($role = "Reseller")
	{
	   echo "<meta http-equiv='Refresh' Content='1; url=../?page=reseller-licenses'>"; 
	}
	else
	{
